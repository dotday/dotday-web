...
import { DEFAULT_SPLIT_HERO } from "@/components/sections/heroes/HomeHero";
import { DEFAULT_GROUND_CONDITION_CARDS } from "@/components/sections/product/UseCases";
import { DEFAULT_TESTIMONIALS } from "@/components/sections/proof/Testimonials";
import { DEFAULT_TOOLS_BAND } from "@/components/sections/conversion/ToolsBand";
import { DEFAULT_INSTALL_SHOWCASE } from "@/components/sections/media/InstallShowcase";
import { DEFAULT_QUOTE_BAND } from "@/components/sections/proof/QuoteBand";
import { DEFAULT_JOB_GALLERY } from "@/components/sections/proof/JobGallery";
import { DEFAULT_HOME_STAT_STRIP } from "@/components/sections/proof/HomeStatStrip";
import { DEFAULT_FABRIC_MATRIX } from "@/components/sections/product/CompareTable";
import { DEFAULT_HOME_VIDEO_FEATURE } from "@/components/sections/media/HomeVideoFeature";
import { DEFAULT_APPLICATION_GALLERY } from "@/components/sections/product/ApplicationGallery";
import { DEFAULT_REAL_JOBS } from "@/components/sections/proof/RealJobs";
import { DEFAULT_INSTAGRAM_FEED } from "@/components/sections/media/InstagramFeed";
